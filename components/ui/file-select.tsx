    ...
    >
      <div
        className={[
          ...
          'hover:border-black hover:bg-secondary/80',
          'text-center color-red',
          dragHover ? 'border-black bg-secondary' : 'bg-gray-100 border-gray-300',
        ].join(' ')}
        onDrop={handleDrop}
        onDragOver={ev => {
          ev.stopPropagation()
      ...
      >
        <input
          ...
          accept="audio/mpeg"
        />
        <p className='text-secondary-foreground'>Drop your MP3 file here</p>
      </div>
    </label>
  )
}
